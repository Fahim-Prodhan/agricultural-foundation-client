      ...
      <div className="relative">
        ...
        >
          <SwiperSlide className="w-[20px]">
            <img className="md:max-h-[600px]" src={img1} alt="" />
          </SwiperSlide>
          <SwiperSlide className="w-[20px]">
            <img className="md:max-h-[600px]" src={img2} alt="" />
          </SwiperSlide>
          <SwiperSlide className="w-[20px]">
            <img className="md:max-h-[600px]" src={img3} alt="" />
          </SwiperSlide>
        </Swiper>
        ...
        <div className="px-6 lg:px-0 w-full md:space-y-4 text-center z-20 absolute top-[45%] left-1/2 text-white -translate-x-1/2 -translate-y-1/2">
          <p className="md:text-xl font-semibold">DONATE</p>
          <h1 className="text-2xl lg:text-5xl lg:font-black font-bold">Change is Possible in Agriculture</h1>
          <p className="md:text-xl">By supporting Farm Foundation, you can be part of the movement to help agriculture thrive.</p>
        </div>
